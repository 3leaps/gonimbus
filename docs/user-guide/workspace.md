...
│   ├── store-70860-dec.yaml
│   └── store-70860-jan.yaml
...
gonimbus index build --job manifests/store-70860-dec.yaml
...
gonimbus index query s3://source-bucket/production/data/ \
  --index-set idx_da038d8171b4a9ba... \
  --pattern '70860/**/CPJR*.xml' \
  --output s3://dest-bucket/project/ops/selections/dec-70860.jsonl \
  --output-profile dest-admin

# Reflow with key rewriting
gonimbus transfer reflow \
  --stdin < selections/dec-70860.jsonl \
