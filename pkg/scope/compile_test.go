...
func TestCompilePrefixList(t *testing.T) {
	...
	require.Equal(t, []string{
		"data/01001/device-a/2025-12-01/",
		"data/01001/device-b/2025-12-02/",
	}, plan.Prefixes)
}
...
func TestCompileDatePartitions(t *testing.T) {
	...
	lister := &fakePrefixLister{prefixes: map[string][]string{
		"data/01001/": {"data/01001/device-a/", "data/01001/device-b/"},
	}}
	...
	require.Equal(t, []string{
		"data/01001/device-a/2025-12-01/",
		"data/01001/device-a/2025-12-02/",
		"data/01001/device-b/2025-12-01/",
		"data/01001/device-b/2025-12-02/",
	}, plan.Prefixes)
}
